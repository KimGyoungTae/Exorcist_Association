...
public class InventoryManager : MonoBehaviour
{
   ...
   public List<InventoryItem> Items = new List<InventoryItem>();
    ...
    [SerializeField] private Button closeButton; // UI 창을 닫기 위한 버튼
    ...
    {
        Items.Clear();
        ListItems(); // 인벤토리 UI 업데이트

        // Reset the displayed information
        UI_itemType.text = "";
        UI_itemName.text = "";
        UI_itemDescription.text = "";
        UI_itemImage.sprite = null;

        Debug.Log("All items removed from the inventory");
    }
